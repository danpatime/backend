    ...
    public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
        ...
        public void onAuthenticationSuccess(final HttpServletRequest request,
            ...
            String targetUrl = determineTargetUrl(request, response, userDetailRequest);
...
//            setResponse(request, response, userDetailRequest);
        ...
        private void generateResponseBody(HttpServletResponse response, UserDetailRequest userDetailRequest, AuthTokenRequest authTokenRequest) throws IOException {
            ...
            responseBody.put("email", loginUser.getEmail());
        ...
        protected String determineTargetUrl(final HttpServletRequest request, final HttpServletResponse response, final UserDetailRequest authentication) {
...
//            }
            String targetUrl = "http://localhost:3000/oauth2/callback/kakao"; // 로그인 성공 후 리다이렉트 url
